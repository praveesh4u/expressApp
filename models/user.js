...
(function() {
  'use strict';
  var _, bcrypt, phonetic, saltRounds;
    ...
    User = sequelize.define('User', {
      ...
      classMethods: {
        ...
        createNewUser: function(data, callback) {
          ...
          return User.genSalt(saltRounds, function(err, hash) {
            ...
            return User.hashPassword(userData.password, hash, function(err, hashedPassword) {
      ...
      instanceMethods: {
        isValidPassword: function(password, cb) {
          ...
          return this.hashPassword(password, this.salt, (function(_this) {
